...
Class TratamientoDAO{
    ...
    public static function getInstancia(){
        if(is_null(self::$instancia)){
            self::$instancia = new TratamientoDAO();
            return self::$instancia;
        }
    }
    function InsertaTratamiento($id_consulta,$id_dtp,$estado_tratamiento){
        $consulta = "insert into tratamiento(id_consulta,id_dtp,estado_tratamiento) values('$id_consulta','$id_dtp','$estado_tratamiento')";
