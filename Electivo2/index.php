              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="View/paciente/listapaciente.php">Paciente</a></li>
                          <li><a  href="view/">Dentista</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="view/area/listaarea.php">Areas</a></li>
                          <li><a  href="view/promocion/listapromocion.php">Promociones</a></li>
                          <li><a  href="view/horario/listahorario.php">Horario Dentista</a></li>
                          <li><a  href="view/cronograma/listacronograma.php">Cronograma</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
