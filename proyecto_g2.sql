...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 17-11-2016 a las 17:45:24
...
CREATE TABLE `cita` (
  ...
  `estado_cita` enum('R','C','F') DEFAULT 'R'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `turno` (`id_turno`, `nom_turno`, `hora_inicio`, `hora_fin`) VALUES
(1, 'Mañana', '07:30:00', '12:00:00'),
(2, 'Tarde', '13:30:00', '18:00:00');
...
--
ALTER TABLE `dentista`
  MODIFY `id_dentista` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
...
--
ALTER TABLE `dt_promocion`
  MODIFY `id_dtp` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
ALTER TABLE `odontograma`
  MODIFY `id_odontograma` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
--
