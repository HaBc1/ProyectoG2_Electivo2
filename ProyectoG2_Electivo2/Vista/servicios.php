            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Registrar servicio</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Descripcion del servicio:</label>
                              <div class="col-sm-10">
                                  <input type="text"  class="form-control">
                              </div>
                          </div>
                           ...
                           <div class="form-group">
                              ...
                              <label class="col-sm-2 col-sm-2 control-label">Estado Servicio:</label>
                              <div class="btn-group">
