                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nombre Promocion:</label>
                              <div class="col-sm-10">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Descripcion de la promocion:</label>
                              <div class="col-sm-10">
                                  <input type="text"  class="form-control">
                              </div>
                          </div>
                           ...
                           <div class="form-group">
                              ...
                              <label class="col-sm-2 col-sm-2 control-label">Estado Promocion:</label>
                              <div class="btn-group">
