          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="calendar.html">Cita</a></li>
                          <li><a  href="gallery.html">Consulta</a></li>
                          <li><a  href="todo_list.html">Tratamiento</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Dni Dentista:</label>
                              
                                  <table>
                                    <tr>
                                      <td colspan="1"><div class="col-sm-10"><input type="text"  class="form-control"></div> </td>
                                      <td> <button type="button" class="btn btn-theme02"><i class="fa fa-search"></i> Buscar</button></td>
                                    </tr>
                                  </table>  
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Nombre Dentista:</label>
                              <div class="col-sm-10">
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Apellido Dentista:</label>
                              <div class="col-sm-10">
                                  <input type="text"  class="form-control">
                              </div>
                          </div>
                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <label class="col-sm-2 col-sm-2 control-label">Estado Dentista:</label>
                              <div class="btn-group">
                                <button type="button" class="btn btn-theme03 dropdown-toggle" data-toggle="dropdown" style="margin-left: 13px;"> 
