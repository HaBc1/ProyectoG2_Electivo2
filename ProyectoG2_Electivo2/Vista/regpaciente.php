            ...
            <div class="row mt">
              <div class="col-lg-12">
                  <div class="form-panel">
                      <h4 class="mb"><i class="fa fa-angle-right"></i> Registrar Paciente</h4>
                      <form class="form-horizontal style-form" method="get">
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Dni Paciente:</label>
                           ...
                           <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">NombrePaciente:</label>
                              <div class="col-sm-10">
                           ...
                           <div class="form-group">
                              ...
                              <label class="col-sm-2 col-sm-2 control-label">Estado Paciente:</label>
                              <div class="btn-group">
